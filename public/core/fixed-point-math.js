...
// Rust one — this module closes it, verified for real against an
// independent Rust port in interop/rust-vdf (see tests/rust-interop.test.mjs).
//
...
// above the 18 decimals AIWA's own base units (units.js) ever need — see
// fixed-point-math.test.mjs for the actual, measured error bound.
//
...
// |y|<=1/3 pushes the largest dropped term below 3^-121 — see
// fixed-point-math.test.mjs for the real, measured resulting error
// against Math.log, comfortably inside FRAC_BITS' own ~2^-128 resolution.
...
// same reasoning the rest of this project applies everywhere else
// ("recompute, don't trust a hand-carried value").
...
// 0.3466^41/41! — see fixed-point-math.test.mjs for the measured bound.
